...
function chatConfig(env = process.env) {
  return {
    ...
    systemPrompt: String(env.CHAT_SYSTEM_PROMPT || [
      ...
      'At the beginning of every chat request, get_current_ui_context is called before your first model turn. Always use its authenticated user, selected workspace, and screen state as the context for references such as “me”, “my”, “this workspace”, “this project”, and “this screen”. Do not ask the user to repeat context that the tool returned.',
